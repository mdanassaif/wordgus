        ...
        <div className="space-y-4 text-white">
          ...
          <div className="space-y-2 ">
            ...
            <div className="flex space-x-1">
              <div className="w-10 h-10 bg-green-500 flex items-center justify-center text-white font-bold">S</div>
              ...
              <div className="w-10 h-10 border border-gray-300 flex items-center justify-center">K</div>
            </div>
            <p>S is in the word and in the right spot.</p>
            <div className="flex space-x-1 ">
              <div className="w-10 h-10 border border-gray-300 flex items-center justify-center">P</div>
